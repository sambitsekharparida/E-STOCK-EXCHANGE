        ...
        <div className="flex max-w-2xl mx-auto shadow border-b pt-2">
            <div className='px-8 py-8'>
                ...
                <div className='item-centered justify-center h-14 w-full my-4'>
                    <label className='block text-grey-600 text-sm font-normal text-2xl'>Code</label>
                    <input 
                        type="text" 
                        name="code" 
                ...
                <div className='item-centered justify-center h-14 w-full my-4'>
                    <label className='block text-grey-600 text-sm font-normal text-2xl'>Price</label>
                    <input 
                        type="text" 
                        name='price'
                        id='price'
